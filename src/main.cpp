...
// Include UI files generated by Squareline Studio
#include "../ui/ui.h"
...
void setup() {
  ...
  Serial.println("Starting M4 7-inch RGB Display UI: M4_2025...");
  ...
  // Create LVGL task on second core
...
void loop() {
  ...
  // Update benchmark display if enabled
  benchmark_update();

  delay(5);  // Small delay to not overload the CPU
}